...
- A_clean_data_and_annotation: PASS
- B_b1_beats_random: PASS
- C_b2_beats_b1: PASS
- D_weak_pretraining_helps: PASS
- E_hierarchical_vs_flat_under_shift: PASS
- F_soft_labels_help_ambiguity: PASS
- G_evidence_plausibility_addressed: PASS
